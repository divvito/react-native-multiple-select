...
export default class InputGroup extends React.PureComponent {
    render() {
        ...
        return (React.createElement(View, { style: [styles.inputGroup, inputGroupStyle] },
            ...
            React.createElement(TextInput, { autoFocus: true, onChangeText: onChange, blurOnSubmit: true, onSubmitEditing: onAdd, placeholder: searchInputPlaceholderText, placeholderTextColor: searchInputPlaceholderColor, underlineColorAndroid: "transparent", style: [styles.searchInput, searchInputStyle], value: searchTerm, disableFullscreenUI: true }),
            indicatorOpen));
    }
}
